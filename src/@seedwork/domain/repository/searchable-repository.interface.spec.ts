...
describe("SearchableRepository - Search Params Unit Test", () => {
  test(" page props", () => {
    ...
    arrange.forEach((data) => {
      expect(new SearchParams({ page: data.page }).page).toBe(data.expected);
    });
  });
...
describe("SearchableRepository - Search Result Unit Test", () => {
